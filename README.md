# 🌐 Project Samarth - AI Data Assistant (Powered by data.gov.in)
...
It uses real-time data from [data.gov.in](https://data.gov.in), the Government of India's open data platform.
